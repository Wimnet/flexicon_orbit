...
# Generated: Thu Apr  5 12:40:36 2018
##################################################
...
class dig_sic_on_psk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.func_dig_sic = func_dig_sic.sic(frame_size=frame_size, preamble_size=pream_size, k=k, order=1, frames=frames, error_report=0, warning_report=0, information_report=0)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, file_usrp_in, False)
    ...
    def set_file_usrp_in(self, file_usrp_in):
        ...
        self.blocks_file_source_0.open(self.file_usrp_in, False)
